...
partial class ScheduleTests
{
    ...
    public void GetIntersectedStateAt_WithTwoSchedulesFirstIsNull_ThrowsArgumentNullException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithTwoSchedulesSecondIsNull_ThrowsArgumentNullException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithTwoSchedules_ReturnsIntersectedState(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithThreeSchedulesFirstIsNull_ThrowsArgumentNullException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithThreeSchedulesSecondIsNull_ThrowsArgumentNullException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithThreeSchedulesThirdIsNull_ThrowsArgumentNullException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithThreeSchedules_ReturnsIntersectedState(LocalDateTime dateTime)
    {
        using (new AssertionScope())
        {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithNullScheduleArray_ThrowsArgumentNullException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithScheduleArrayContainingNull_ThrowsArgumentException(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithEmptyScheduleArray_ReturnsTrue(LocalDateTime dateTime)
    {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithOneSchedule_ReturnsSameState(LocalDateTime dateTime)
    {
        using (new AssertionScope())
        {
    ...
    [Theory]
    [MemberData(nameof(TestData.GetDateTimes), MemberType = typeof(TestData))]
    public void GetIntersectedStateAt_WithScheduleArray_ReturnsIntersectedState(LocalDateTime dateTime)
    {
        using (new AssertionScope())
        {
            foreach (var (firstState, secondState, result) in TestData.GetTwoIntersectedStates())
